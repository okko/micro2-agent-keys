...
[../src/research/keymap.ts](../src/research/keymap.ts) binds `AG00`..`AG05` to the first six keys. Bind
...
- The rc.15 image carries **two** default keymaps as plaintext JSON (**image**): the
  ...
  [../src/research/keymap.ts](../src/research/keymap.ts). Neither carries a `lights` object.
